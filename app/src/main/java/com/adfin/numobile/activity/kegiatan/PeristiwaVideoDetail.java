...
public class PeristiwaVideoDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.detail_content_peristiwa_video);
        ...
        photo = (VideoView) findViewById(R.id.header_cover_image);
                ...
                new Callback<CDataDetail>(){
                    ...
                    public void success(CDataDetail cdataperistiwa, Response response) {
                        ...
                        if(lstdataperistiwa.size() != 1)
                            ...
                            Uri video = Uri.parse(lstdataperistiwa.get(0).getpath());
                            photo.setVideoURI(video);
                            photo.requestFocus();
                            photo.start();
