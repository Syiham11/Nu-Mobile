...
public interface ModulAPI {
    ...
    @GET("/NUMobile/ceksudahdaftar.php")
    ...
    public void insertdataanggota(//insertdataanggota dipanggil ketika bikin prosedur
            @Field("vsid_warga") String vsid_warga,
            @Field("vsusername") String vsusername,
            @Field("vsnama") String vsnama,
            @Field("vsnoktp") String vsnoktp,
    ...
    @FormUrlEncoded
    @POST("/NUMobile/simpanLatLong.php")
