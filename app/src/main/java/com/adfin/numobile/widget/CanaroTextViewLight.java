 ...
 */
public class CanaroTextViewLight extends TextView {
    public CanaroTextViewLight(Context context) {
        this(context, null);
    }

    public CanaroTextViewLight(Context context, AttributeSet attrs) {
